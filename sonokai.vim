...
call sonokai#highlight('IllCursor', s:palette.none, s:palette.grey_dim)
call sonokai#highlight('Pick', s:palette.pick, s:palette.none)
call sonokai#highlight('Struct', s:palette.struct, s:palette.none)
call sonokai#highlight('Field', s:palette.field, s:palette.none)
call sonokai#highlight('Operator', s:palette.operator, s:palette.none)
call sonokai#highlight('Call', s:palette.call, s:palette.none)
call sonokai#highlight('Return', s:palette.return, s:palette.none)
if s:configuration.enable_italic
...
if &diff
  call sonokai#highlight('CurrentWord', s:palette.bg_green, s:palette.green)
...
hi default UfoFoldedFg guifg=Green
hi default UfoFoldedBg guifg=Red
" 定义一个 syn 的高亮组叫 goCapitalizedWord
" syn match goCapitalizedWord "\v<[A-Z]\w*>" contains=ALL
"
" " 设置 goCapitalizedWord 高亮组的颜色为蓝色
" hi goCapitalizedWord ctermfg=blue guifg=blue
"
" " 设置 goCapitalizedWord 高亮组可以被包含在 tree-sitter 的 type 高亮组中
" syn cluster TSInclude add=goCapitalizedWord

" syntax match GoInterfaceName "type\s\+\zs\w\+\ze\s\+interface" contained
" highlight link GoInterfaceName Red
" hi default link UfoFoldedEllipsis Blue
" hi default link UfoCursorFoldedLine Purple
...
highlight! link TSConditional Pick
...
highlight! link TSFunctionCall Red
highlight! link TSInclude Red
highlight! link TSKeyword Pick
highlight! link TSKeywordFunction Pick
highlight! link TSKeywordOperator Red
highlight! link TSKeywordReturn Return
highlight! link TSLabel Red
highlight! link TSLiteral String
highlight! link TSMath Yellow
highlight! link TSMethod Call
highlight! link TSMethodCall Call
...
highlight! link TSType Struct
highlight! link TSTypeBuiltin Red
highlight! link TSTypeDefinition Struct "BlueItalic
...
if has('nvim-0.9.0')
  ...
  highlight! link @lsp.type.interface Purple
...
highlight! link LspSemanticInterface Purple
...
highlight! link IlluminatedWordText IllCursor
